...
flags.DEFINE_string('run',
                    ...
                    required=True)
flags.DEFINE_string('mode', #RAVE pr256
                     default='last', #RAVE pr256
                     help='Choose between exporting the last checkpoint or the best. Default is "last"', #RAVE pr256
                     required=False) #RAVE pr256
